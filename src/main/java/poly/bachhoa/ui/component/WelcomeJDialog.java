...
public class WelcomeJDialog extends javax.swing.JDialog implements WelcomeController{
    ...
    private void initComponents() {
        ...
        jPanel1.setMaximumSize(new java.awt.Dimension(441, 237));
        jPanel1.setPreferredSize(new java.awt.Dimension(457, 237));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Gemini_Generated_Image_c14dc1c14dc1c14d.png"))); // NOI18N
    ...
    @Override
   public void waiting() {
    this.setLocationRelativeTo(null); // Căn giữa WelcomeJDialog
    new Thread(() -> {
        try {
            // Chạy progressBar từ 0 → 100
            for (int i = 0; i <= 100; i++) {
                progressBar.setValue(i); // Cập nhật progressBar
                Thread.sleep(10);        // Giả lập load
            }
            WelcomeJDialog.this.dispose(); // Đóng WelcomeJDialog
            // Sau khi load xong, mở LoginForm
            LoginForm login = new LoginForm(); // tạo form login
            login.setVisible(true);            // hiển thị form login
